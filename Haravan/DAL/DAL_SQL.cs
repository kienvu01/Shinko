...
namespace Haravan.DAL
{
    public class DAL_SQL
    {
        ...
        public static DataSet ExecuteGetlistDataset(string sqlQuery)
        {
            ...
            {
                throw new Exception("sqlQuery: " + sqlQuery + "::" + ex.Message+"....."+conStr, ex);
            }
        ...
        public static int ExecuteNonquery(string sqlQuery)
        {
            ...
            {
                errorException = ex;
                throw new Exception("sqlQuery: " + sqlQuery + "::" + ex.Message, ex);
            }
        }
        public static int ExecuteNonquery(String _queryStore, SqlParameter[] sqlParameter)
        {
            ...
            {
                errorException = ex;
                throw new Exception("sqlQuery: " + _queryStore+ "_" +ex.Message, ex);
            }
            catch(Exception e)
            {
                errorException = e;
                throw new Exception("sqlQuery22: " + _queryStore + "_" + e.Message, e);
            }
        }
    }
}
