...
namespace Haravan.Haravan.Model
{
    public class DTOOrder
    {
        ...
        public async static Task<String> CreatSqlOrder(JObject obj, string token,string host)
        {
            try
            {
